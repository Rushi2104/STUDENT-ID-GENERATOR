...
<body>
    ...
    <div class="container jumbotron mt-4 textbox-shadow rounded ">
        <div class="row text-dark" style="margin-right:auto;">
            <div class="col-sm-6 textbox-shadow jumbotron">
                <h1 class="text-center text-shadow">Feedback</h1>
                <hr>
                    ...
                    <div class="p-3 border rounded bg-light text-dark">
                        ...
                        <form action="" method="POST" class=" bg-light" id="myform">
                            ...
                            <div class="mb-3 text-center">
                                <input type="submit" value="Submit" class="btn btn-primary button-shadow"
                                    onclick="allfield()">
                            </div>
                    </div>
                </div>
    ...
    <footer class="container-fluid bg-dark text-center p-2">
        <small class="text-white">Copyright &copy; 2020 || Design By Shubham Lagad & Sagar Rote || <a
                href="adminlogin.html">Admin
                Login</a></small>
    </footer>
    <!-- end footer -->
